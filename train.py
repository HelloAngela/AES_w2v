...
print
'The length of score range is {}'.format(len(score_range))
...
print
'The size of training data: {}'.format(n_train)
print
'The size of testing data: {}'.format(n_test)
print
'The size of evaluation data: {}'.format(n_eval)
with open(out_dir + '/params', 'a') as f:
    ...
    with tf.Session(config=session_conf) as sess:
        ...
        for i in range(1, epochs + 1):
            ...
            for start, end in batches:
                ...
                train_cost += cost
            print
            'Finish epoch {}, total training cost is {}, time spent is {}'.format(i, train_cost, total_time)
            # evaluation
